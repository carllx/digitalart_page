...
declare module "reconciler" {
    ...
    export function createPortal(children: any, containerInfo: any, implementation: any, key?: null): {
...
declare module "canvas" {
    ...
    export const Canvas: React.MemoExoticComponent<({ children, gl, camera, orthographic, raycaster, style, pixelRatio, vr, invalidateFrameloop, updateDefaultCamera, onCreated, ...rest }: CanvasProps) => JSX.Element>;
}
declare module "hooks" {
    ...
    export function useUpdate(callback: Function, dependents: [], optionalRef?: React.MutableRefObject<any>): React.MutableRefObject<any>;
